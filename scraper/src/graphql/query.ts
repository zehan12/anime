export function graphqlTrendingQuery(page = 1, perPage = 10, type = 'ANIME') {
...
export function graphqlUpcomingQuery(page: number) {
    const perPage = 20;
...
export function graphqlSearchQuery(query: {}, page: number, perPage = 10, type = 'ANIME') {
...
export function graphqlMediaDetailQuery(id: number) {
